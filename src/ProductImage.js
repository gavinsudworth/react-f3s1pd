          ...
          <div class="b-photoswipe-info" data-ref="dialog">
            <span class="b-zoom_info">
              <span class="b-zoom_info-icon">
                ...
                >
                  <g fill="none" fill-rule="evenodd" transform="translate(1 1)">
                    ...
                    <path
                      fill="currentColor"
                      d="M8 4h2v10H8zm6.8 11.2l1.4-1.4 7 7-1.4 1.4z"
                    ></path>
                    <path fill="currentColor" d="M4 10V8h10v2z"></path>
                  </g>
                </svg>
              </span>
              <span class="b-zoom_info-icon_sm">
                ...
                >
                  <g fill-rule="evenodd">
                    <path d="M29.2 15a.8.8 0 01-.6-.2L15.2 1.4A.8.8 0 0116.4.2l13.4 13.4a.8.8 0 01-.6 1.4"></path>
                    <path d="M29.1 15H24a.9.9 0 010-1.8h4.4V9a.9.9 0 011.7 0V14a.9.9 0 01-.9.9M16 7a.9.9 0 01-.9-.9V1c0-.5.4-.9.9-.9H21a.9.9 0 010 1.8h-4.4V6a.9.9 0 01-.8.9M2.5 19a.8.8 0 00-.8.8v6.7a5.8 5.8 0 005.8 5.8h2.8a4.2 4.2 0 003-1.3l6.8-7.4a.8.8 0 000-1 2.1 2.1 0 00-2.8-.5l-2.7 1.8a.8.8 0 01-1.3-.7V11.5a.8.8 0 00-1.6 0v9.2a.8.8 0 01-1.7 0v-4.2a.8.8 0 00-1.7 0v4.2a.8.8 0 01-1.6 0v-2.5a.8.8 0 00-1.7 0v2.5a.8.8 0 01-1.7 0v-.9a.8.8 0 00-.8-.8m7.8 15H7.5A7.5 7.5 0 010 26.5v-6.7a2.5 2.5 0 013.4-2.3 2.5 2.5 0 013.4-1.7 2.5 2.5 0 013.2-1.7v-2.6c0-1.4 1.1-2.5 2.5-2.5a2.5 2.5 0 012.5 2.5v10.1l1.4-1a3.8 3.8 0 015.1 1 2.5 2.5 0 01-.2 3.1l-6.7 7.4a5.9 5.9 0 01-4.3 1.9"></path>
                    <path d="M14.2 37a.8.8 0 01-.8-.8v-2.5H3.6v2.5c0 .4-.3.8-.8.8a.8.8 0 01-.8-.8v-3.4c0-.4.4-.8.8-.8h11.4c.4 0 .8.4.8.8v3.4c0 .4-.4.8-.8.8"></path>
                  </g>
                </svg>
              </span>
            ...
            >
              ...
              >
                <g transform="translate(-1198 -577)">
                  <path
                    d="M1 0H0v16h1V0z"
                    transform="rotate(45 -93.258 1751.685)"
                  ></path>
                  <path
                    d="M16 0H0v1h16V0z"
                    transform="rotate(45 -98.561 1738.882)"
                  ></path>
                </g>
              </svg>
            </button>
